...
public class GraphingCalculator {
    ...
    private comp127graphics.ui.Button zoomIn;
    private comp127graphics.ui.Button zoomOut;
    ...
    public GraphingCalculator(int width, int height) {
        ...
        zoomOut = new comp127graphics.ui.Button("Zoom Out");

        canvas.add(zoomIn);
        canvas.add(zoomOut);

        zoomIn.setPosition(20,30);
        zoomOut.setPosition(150,30);
        ...
        canvas.onDrag(event ->
                setAnimationParameter(getAnimationParameter() +
