...
public class LibraryMain {
    ...
    public static void main(String[] args) {
        ...
        library.add(new Video("Bob the Builder", "Steven Spielberg", 6));
        library.add(new Video("Thomas the Tank Engine", "Quentin Tarantino", 8));
        library.add(new Video("Barney","Christopher Nolan", 3));
        library.add(new Video("Dora the Explorer","Clint Eastwood", 10));
